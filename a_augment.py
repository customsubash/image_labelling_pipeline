...
def augment_images(input_location, output_location, transform_json_path):
    transform = load_transform_from_json(transform_json_path)
    os.makedirs(output_location, exist_ok=True)

    for fname in os.listdir(input_location):
        in_path = os.path.join(input_location, fname)
        ...
        out_path = os.path.join(output_location, fname)
