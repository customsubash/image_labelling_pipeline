...
def main():
    ...
    try:
        ...
        augment_images(
            input_location='input_images',
            output_location='results/aug_images',
            transform_json_path='configs/transforms.json'
        )
        ...
        save_as_coco_from_files(
            predictions_location="results/inference_results",
            output_location='results/coco_results'
        )
